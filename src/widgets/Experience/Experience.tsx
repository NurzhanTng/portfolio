        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            ...
            work="Worked on a team responsible for developing new features for Google's
              search engine, including improving the accuracy and relevance of search results
              and developing new tools for data analysis and visualization."
          />
          ...
          <Details
            ...
            work="Worked on a team responsible for developing a new mobile app
              ...
              content, including designing and implementing a new user interface and
